...
A full multiplayer gaming platform built in Java, using BlueJ, as a school project. 44+ playable games, ELO ratings, a party system, tournaments, and the ability for anyone to host their own server.
