...
- **`GameLauncher.java`** — the plugin **launch** dispatch, and the mandatory
  ...
  gate since there's nothing to preview yet. 35 games so far are the exceptions
  ...
  Shooter, Battleship, Memory Match, and Word Duel - every offline/single-
  player game in the whole catalog, plus both games with
