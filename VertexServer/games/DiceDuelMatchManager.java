 ...
 * ---------------------
 * Matchmaking for Dice Duel - same shape as CheckersMatchManager.
 */
public class DiceDuelMatchManager
{
    ...
    private final Map<String, DiceDuelMatch> activeMatches = new HashMap<String, DiceDuelMatch>();
    ...
    public DiceDuelMatchManager(EconomyManager economyManager, GameHistoryManager gameHistoryManager,
    ...
    public synchronized void findMatch(ClientHandler player)
    {
        ...
        if (!waitingPlayers.isEmpty())
        {
            ...
            String matchId = "diceduel-" + (nextMatchId++);
            DiceDuelMatch match = new DiceDuelMatch(matchId, opponent, player, this, economyManager, leaderboardManager);
            activeMatches.put(matchId, match);
            opponent.setCurrentDiceDuelMatch(match);
            player.setCurrentDiceDuelMatch(match);
            match.start();
