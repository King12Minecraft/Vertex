 ...
 * -----------------------
 * Matchmaking for Competitive Tetris - same shape as CheckersMatchManager.
 */
public class TetrisDuelMatchManager
{
    ...
    private final Map<String, TetrisDuelMatch> activeMatches = new HashMap<String, TetrisDuelMatch>();
    ...
    public TetrisDuelMatchManager(EconomyManager economyManager, GameHistoryManager gameHistoryManager,
    ...
    public synchronized void findMatch(ClientHandler player)
    {
        ...
        if (!waitingPlayers.isEmpty())
        {
            ...
            String matchId = "tetrisduel-" + (nextMatchId++);
            TetrisDuelMatch match = new TetrisDuelMatch(matchId, opponent, player, this, economyManager, leaderboardManager);
            activeMatches.put(matchId, match);
            opponent.setCurrentTetrisDuelMatch(match);
            player.setCurrentTetrisDuelMatch(match);
            match.start();
