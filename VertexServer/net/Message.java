...
public class Message implements Serializable
{
    ...
    // ---- Public profile view (also reused by achievement notifications) ----
    private java.util.List<String> syncRatings;

    /** That account's rating in every game it's rated in, "gameId:rating" per entry - used by the public profile view (PLAYER_PROFILE_RESPONSE), since ELO lives in LeaderboardManager separately from the Account object itself. */
