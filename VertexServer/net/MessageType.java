...
public enum MessageType
{
    ...
    ADMIN_SET_ROLE_REQUEST,
    ADMIN_SET_ROLE_RESPONSE,
    ADMIN_LOG_REQUEST,
    ADMIN_LOG_RESPONSE,
    ...
    ADMIN_BAN_RESPONSE,
    ADMIN_UNBAN_REQUEST,
    ADMIN_UNBAN_RESPONSE,
    ADMIN_BAN_LIST_REQUEST,
    ADMIN_BAN_LIST_RESPONSE,

    // --- Telephone (Gartic-Phone-style draw/guess chain, 4-8 players - see TelephoneMatch) ---
    TELEPHONE_FIND_MATCH_REQUEST,
    TELEPHONE_LEAVE_QUEUE_REQUEST,
    TELEPHONE_ROUND_START,
    ...
    DOMINION_STATE_REQUEST,
    DOMINION_STATE_RESPONSE
}
