package pages;
import economy.AchievementToast;
...
public class MainMenu extends JFrame implements NavigationListener, NetworkManager.PushListener
{
    ...
    public MainMenu()
    {
        ...
        contentPanel.add(new GameSuggestionsPanel(), Pages.GAME_SUGGESTIONS);
    ...
    private String titleFor(String pageKey)
    {
        ...
        if (pageKey.equals(Pages.GAME_SUGGESTIONS)) return "Suggest a Game";
