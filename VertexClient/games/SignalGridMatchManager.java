...
/**
 * SignalGridMatchManager
 * -----------------------
 * Matchmaking for Signal Grid - same shape as CheckersMatchManager.
 */
public class SignalGridMatchManager
{
    ...
    private final Map<String, SignalGridMatch> activeMatches = new HashMap<String, SignalGridMatch>();
    ...
    public SignalGridMatchManager(EconomyManager economyManager, GameHistoryManager gameHistoryManager,
    ...
    public synchronized void findMatch(ClientHandler player)
    {
        ...
        if (!waitingPlayers.isEmpty())
        {
            ...
            String matchId = "signalgrid-" + (nextMatchId++);
            SignalGridMatch match = new SignalGridMatch(matchId, opponent, player, this, economyManager, leaderboardManager);
            activeMatches.put(matchId, match);
            opponent.setCurrentSignalGridMatch(match);
            player.setCurrentSignalGridMatch(match);
            match.start();
