 ...
 * Again when a piece can't spawn. Embedded in MainMenu's game-host
 * slot (see ChessWindow's javadoc for the pattern); requestLeave()
 * just stops the panel's timer.
 */
public class TetrisWindow extends JPanel implements EmbeddedGamePanel
{
