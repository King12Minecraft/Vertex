 ...
 * the other single-player games.
 */
public class BrickBreakerWindow extends JFrame
{
    ...
    private void finishGame()
    {
        ...
        SnakeGameOverDialog.show(this, finalScore,
            ...
            new SnakeGameOverDialog.Choice()
            {
                ...
                public void onClose() { BrickBreakerWindow.this.dispose(); }
            });
    }
