 ...
 * DinoWindow
 * ----------
 * The Chrome Dino runner, embedded in MainMenu's game-host slot (see
 * ChessWindow's javadoc for the pattern). Spacebar (or Up) to jump.
 * Single-player, fully offline, same recordPlayed pattern as Racing
 * (no coin reward). requestLeave() just stops RunPanel's timer.
 */
public class DinoWindow extends JPanel implements EmbeddedGamePanel
{
    ...
    private void startGame()
    {
        ...
        centerer.add(runPanel, new GridBagConstraints());
